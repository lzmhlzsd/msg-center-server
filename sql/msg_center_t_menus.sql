...
CREATE TABLE `t_menus` (
  ...
  `c_name` varchar(45) DEFAULT NULL COMMENT '菜单名称',
  `c_pid` int(11) DEFAULT NULL COMMENT '父ID',
  `c_desc` varchar(45) DEFAULT NULL COMMENT '描述',
...
-- Dump completed on 2017-01-17 21:51:45
